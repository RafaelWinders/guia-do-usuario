...
!!! note "Daily Reports are not created via Chat"
    As of the v3.x redesign, **daily reports** are created and filled in directly on the Daily Reports screen — no longer through the Chat. See the [Daily Reports Guide](daily-reports.md).
...
!!! tip "Daily reports: use the dedicated screen"
    The Chat no longer creates daily reports automatically. To report field progress, use the **"Daily Reports"** page in the sidebar menu. See the [Daily Reports Guide](daily-reports.md).
...
## 15. Manage inventory through Chat
...
| Create daily report | Not via Chat — use the [Daily Reports](daily-reports.md) page |
